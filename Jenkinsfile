    ...
    stages {
        ...
        stage('Deploy to Dev') {
            ...
            steps {
                ...
                sh '/home/apictl/apictl add-env -e dev --apim https://192.168.0.113:9443/ --token  https://192.168.0.113:8243/token' 
        ...
        stage('Deploy to Local Environment') {
            ...
            steps {
                ...
                sh '/home/apictl/apictl version'
                sh '/home/apictl/apictl add-env -e host --apim https://localhost:9443 --token  https://localhost:9443/token'
