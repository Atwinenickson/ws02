    ...
    stages {
        ...
        stage('Deploy to Dev') {
            ...
            steps {
                ...
                sh '/home/apictl/apictl apictl add-env dev --apim https://192.168.0.113:9443/ --token  https://192.168.0.113:8243/token' 
        ...
        stage('Deploy to Local Environment') {
            ...
            steps {
                ...
                sh '/home/apictl/apictl version'
                sh '/home/apictl/apictl apictl add-env host --apim https://localhost:9443 --token  https://localhost:9443/token'
